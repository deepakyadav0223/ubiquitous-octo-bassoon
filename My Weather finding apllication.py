...
def tellWeather():
    ...
    if x["cod"] != '404':
        ...
        temp_field.insert(10,str(current_temperature)+ " Kelvin")
...
if __name__ == "__main__":
    root = Tk()
    root.title("Weather Finding Application ")
    root.configure(background = "coral")
    root.geometry("485x350")
    headlabel  = Label(root,text = "Weather Finding Application",fg ='black',bg = 'aqua')
    label1 = Label(root,text  = "City Name : ",fg = 'black',bg = 'yellow')
    label2  = Label(root,text  = "Temperature : ",fg = 'black',bg = 'yellow')
    label3 = Label(root, text="Pressure : ", fg='black', bg='yellow')
    label4 = Label(root, text="Humidity : ", fg='black', bg='yellow')
    label5 = Label(root, text="Description : ", fg='black', bg='yellow')
    ...
    button1 = Button(root,text  = "Submit" ,bg = "chartreuse",fg = "black",command  = tellWeather)
